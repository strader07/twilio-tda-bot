...
import urllib3
from .config import USERNAME, PASSWORD, ACCOUNT_NUMBER, CLIENT_ID, REDIRECT_URI, question1, question2, question3, question4, myanswer1, myanswer2, myanswer3, myanswer4
...
class TDClient():
    ...
    def grab_access_token(self):        
        ...
        token_response = requests.post(url = self.config['token_endpoint'], data = data, verify=False)
    ...
    def token_refresh(self):
        ...
        response = requests.post(self.config['token_endpoint'], data=data, verify=False)
    ...
    def get_quotes(self, instruments = None):
        ...
        return requests.get(url = url, headers = merged_headers, params=data, verify=False).json()
    ...
    def get_transactions(self, account = None, transaction_type = None, symbol = None, 
        ...
        if transaction_id:
            ...
            # return the response of the get request.
            return requests.get(url = url, headers=merged_headers, verify=False).json()
    ...
    def update_preferences(self, account = None, dataPayload = None):
        ...
        # make the request
        response = requests.put(url = url, headers = merged_headers, data = json.dumps(dataPayload), verify=False)
    ...
    def create_watchlist(self, account = None, name = None, watchlistItems = None):
        ...
        # make the request
        response = requests.post(url = url, headers = merged_headers, data = json.dumps(payload) , verify=False)
    ...
    def delete_watchlist(self, account = None, watchlist_id = None):
        ...
        # make the request
        return requests.delete(url = url, headers = merged_headers, verify=False).status_code
    ...
    def update_watchlist(self, account = None, watchlist_id = None, name = None, watchlistItems = None):
        ...
        # make the request
        return requests.patch(url = url, headers = merged_headers, data = json.dumps(payload),  verify=False).status_code
    ...
    def replace_watchlist(self, account = None, watchlist_id_new = None, watchlist_id_old = None, name_new = None, watchlistItems_new = None):
        ...
        # make the request
        return requests.put(url = url, headers = merged_headers, data = json.dumps(payload),  verify=False).status_code
    ...
    def get_order(self, account = None, order_id = None):
        ...
        # define the endpoint
        endpoint = 'accounts/{}/savedorders/{}'.format(account, order_id)

        # build the url
        url = self.api_endpoint(endpoint)

        # make the request
        return requests.get(url = url, headers = merged_headers,  verify=False)
    ...
    def cancel_order(self, account = None, order_id = None):
        ...
        # make the request
        return requests.delete(url = url, headers = merged_headers,  verify=False).json()
    ...
    def place_order(self, account = None, order = None):
        ...
        try:
            if 'strategy' in order.keys():
                del order['strategy']
        except: pass

        # make the request
        response = requests.post(url = url, headers = merged_headers, data = json.dumps(order),  verify=False)
    ...
    def message_key(self, account_id = None):
        ...
        # make the request
        response = requests.get(url = url, headers = merged_headers,  verify=False)
        print(response.url)
